...
First, install the [Adoptium Java 17 JDK for macOS ARM64](https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.1%2B12/OpenJDK17U-jdk_aarch64_mac_hotspot_17.0.1_12.pkg).
...
# clone this repo
git clone https://github.com/minecraftdiscordsupportpeeps/m1-multimc-hack.git
```
